...
#ifndef MyScoreAmorphusTrack_hh
#define MyScoreAmorphusTrack_hh
...
class MyScoreAmorphusTrack : public TsVBinnedScorer
{
	public:
		MyScoreAmorphusTrack(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM, TsScoringManager* scM, TsExtensionManager* eM,
				G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);

		virtual ~MyScoreAmorphusTrack();
