...
#ifndef MyScorerMonasTrack_hh
#define MyScorerMonasTrack_hh
...
class MyScorerMonasTrack : public TsVBinnedScorer
{
	public:
		MyScorerMonasTrack(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM, TsScoringManager* scM, TsExtensionManager* eM,
				G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);

		virtual ~MyScorerMonasTrack();
